...
export const Load_Records= createAction(LOAD_RECORDS)
export const Load_PuzzleRecords= createAction(LOAD_PUZZLERECORDS, props<{id: string}>())
export const Load_NationalRecord = createAction(LOAD_NATIONALRECORD, props<{levelID: string, nationalityID:string}>())
export const Record_Success = createAction(RECORD_SUCCESS, props<{record: Record | Record[]}>())
export const Record_Fail = createAction(RECORD_FAIL, props<{error: string}>())
